...
void TypeChecker::validateDecl(ValueDecl *D) {
  ...
  case DeclKind::Func:
  case DeclKind::Accessor: {
    // TODO(tensorflow): Can this now be simplified?
    ...
    if (auto accessor = dyn_cast<AccessorDecl>(FD)) {
      ...
      if (auto SD = dyn_cast<SubscriptDecl>(storage)) {
        ...
        for (size_t i = 0, e = indices->size(); i != e; ++i) {
          ...
          //accessorParam->getTypeLoc().setType(paramIfaceTy);  // TODO(saeta): REMOVE ME? Context: https://github.com/apple/swift/commit/060cbb293f46099e25fcba17c8287938c093012b
        }
      }
      ...
      case AccessorKind::Set: {
        ...
        //newValueParam->getTypeLoc().setType(valueIfaceTy);  // TODO(saeta): REMOVE ME? Context: https://github.com/apple/swift/commit/060cbb293f46099e25fcba17c8287938c093012b
...
// TODO(saeta): Remove me: Context: https://github.com/apple/swift/commit/3dbdc09a4e682cbb1789d7292897d76211819c0d
